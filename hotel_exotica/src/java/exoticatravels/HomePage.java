...
public class HomePage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</table>");
            out.println("<br/>");
            out.println("<B><I><font style='font-family: 'Brush color='darkblue'>Exotica Travels is a travel management company"
                    + "established by Jordan Deilva in Colombo, Sri Lanka. Today under the"
                    + "chairmanship of Jim Henry, the company has spread across the countr. "
                    + "It provides online Air ticket bookiing. In addtion, it provides"
                    + "hotl suite booking in various exotic locations all over the world."
                    + "Moreover, it provides rental car bookings. To avail the travelpacakge services kindly log on to the website.</B></I>");
            out.println("</br>");
            ...
            out.println("<tr><td border color='white'><input type='Radio' value='newuser' name='r2'>New User");
            out.println("<tr><td bordercolor='white'><input type='submit' value='submit' align='centre'>");
            out.println("</table>");
            out.println("</form>");
            out.println("</body>");
            out.println("</html>");
